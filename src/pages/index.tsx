...
export default function Home() {
  ...
  return (
    <div className="">
      {/* Banner */}
      <div className="bg-[url(/img/banner-fhhp.png)] h-[18rem] md:h-[31rem] lg:h-[40rem] bg-cover md:bg-center bg-right">
        <div className="h-full w-full flex px-5 md:px-12 lg:px-20 items-center md:justify-between ">
          <div className="w-[50%] flex flex-col gap-2 -mt-9 md:-mt-20 lg:-mt-36">
            ...
            <a
              className="md:mt-5 border-2 bg-white text-red-700 px-2 py-[4px] flex items-center md:px-6  rounded-lg hover:scale-105 hover:shadow-2xl shadow-lg ease-in-out duration-300 transition-all text-sm md:text-xl w-fit hover:cursor-pointer "
      ...
      <div className="flex flex-col items-center p-5 gap-5 lg:h-[40rem]">
        <h1 className="text-xl lg:text-2xl font-bold lg:mt-10  text-red-700">
          Tentang Fakultas
        </h1>
        <div className="bg-red-700 w-[50%] md:w-[25%] lg:w-[14%] h-[2px] lg:mb-5 " ></div>
        <div className="md:flex gap-32 justify-center lg:px-14 md:h-[28rem] pb-10 ">
          ...
          <div className="md:w-[45%] h-full flex flex-col gap-5 justify-center">
            ...
            <ButtonPrimary
              ClassName="bg-red-700 text-white hover:text-red-700 hover:bg-white hover:border-2 hover:border-red-700 font-semibold ease-in-out duration-300 transition-all"
      ...
      <div className="h-fit bg-[url(/img/bg-kampus.jpg)] bg-center bg-cover">
        <div className="bg-gradient-to-r from-red-300 to-red-700  h-full text-white font-bold flex justify-center items-center gap-6 md:gap-20 lg:gap-36 py-3 md:py-12 px-4 flex-wrap md:flex-row  ">
      ...
      <div className="flex flex-col items-center py-5 lg:py-10 bg-white gap-5 h-fit">
        ...
        <hr className="border-t-[3px] border-red-700 w-[20%] md:w-[15%] lg:w-[6%]  mb-5" />
      ...
      {/* Pengumuman */}
      <div className="h-fit bg-[url(/img/bg-kampus.jpg)] bg-center bg-cover">
        <div className="bg-gradient-to-r from-red-400 to-red-700  h-full flex justify-center items-center gap-6 md:gap-20 lg:gap-36 py-3 md:py-12 px-4 flex-wrap md:flex-row  ">
          <div className="flex flex-col items-center">
            ...
            <div className="w-screen mt-16">
              <Carausel>
               ...
               <div className="mt-10 w-full flex justify-center">
            <ButtonPrimary
              ClassName="hover:bg-red-700 m-auto hover:text-white text-red-700 bg-white border-2 border-red-700 font-semibold ease-in-out duration-300 transition-all"
      ...
      <div className="flex flex-col items-center py-5 lg:py-10 bg-white  h-fit">
        <h1 className="text-xl lg:text-2xl font-bold text-red-700">FAQ</h1>
      ...
      <div className="flex justify-center items-center pb-5 bg-white md:gap-5 h-fit ">
        ...
        />
        <div className="h-32 w-[2px] bg-red-700 mx-2"></div>
        <img
